			<div class="navbar-header">
				...
				<div>
					<a href="<!-- IF brand:logo:url -->{brand:logo:url}<!-- ELSE -->{config.relative_path}/<!-- ENDIF brand:logo:url -->">
			...
			<div class="navbar-collapse collapse navbar-ex1-collapse" id="nav-dropdown">
				...
				<ul id="main-nav" class="nav navbar-nav pull-left">
					...
					<li class="{navigation.class}">
						<a href="{config.relative_path}{navigation.route}" title="{navigation.title}" id="{navigation.id}"<!-- IF navigation.properties.targetBlank --> target="_blank"<!-- ENDIF navigation.properties.targetBlank -->>
				...
				<ul id="logged-in-menu" class="nav navbar-nav navbar-right pull-right">
					...
					<li id="user_label" class="dropdown">
						...
						<ul component="header/usercontrol" id="user-control-list" class="dropdown-menu" aria-labelledby="user_dropdown">
							<li>
								<a component="header/profilelink" href="{config.relative_path}/user/{user.userslug}">
